...
namespace ProyectoFinal_Grupo1_Com2
{
    public partial class HabitacionJacuzzy : Form
    {
        ...
        private void HabitacionTach_Load(object sender, EventArgs e)
        {

        }

        private void CONFIRMAR_Click(object sender, EventArgs e) // evento de un boton que muestra el precio total de las opciones seleccionadas
        {
        ...
        private void HabitacionJacuzzy_Load(object sender, EventArgs e)
        {
